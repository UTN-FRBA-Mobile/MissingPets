...
class MissingAdapterFilter(private val dataset: List<Mascota>, private val onClickListener: OnClickListener)
    : RecyclerView.Adapter<MissingAdapterFilter.MissingViewHolder>() {
