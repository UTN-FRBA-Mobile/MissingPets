 ...
 * Use the [MyAdpotablePostFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class MyAdpotablePostFragment : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null

    private var _binding: FragmentMyAdpotablePostBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMyAdpotablePostBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment MyAdpotablePostFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            MyAdpotablePostFragment().apply {
